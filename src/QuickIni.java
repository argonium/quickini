...
public final class QuickIni
{
  ...
  /**
   * Remove the specified section from the data.
   * 
   * @param sectionName the section to remove
   * @return whether the section was successfuly removed
   */
  public boolean removeSection(final String sectionName)
  {
    ...
    return (contents.remove(sectionName) != null);
  }
  ...
  public static void main(final String[] args)
  {
    ...
    reader.removeSection("GuildFTPd");
